...
class DataExtras<T> {
    ...
    // 不会被放到Activity、Fragment、View的Bundle中
    private Map<String, Object> addition = new ArrayMap<>();
    ...
    public <M> M getAddition(Class<M> clz, String key) {
        Object addition = this.addition.get(key);
        if (clz != null && clz.isInstance(addition)) {
            return clz.cast(addition);
        }
        return null;
    }
    ...
    public void setAddition(@NonNull Map<String, Object> addition) {
