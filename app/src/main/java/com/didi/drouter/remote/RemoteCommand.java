...
class RemoteCommand implements Parcelable {
    ...
    RemoteCommand(Parcel in) {
        ...
        if (type == REQUEST) {
            ...
            extra = in.readBundle(Bundle.class.getClassLoader());
            addition = (Map<String, Object>) RemoteStream.reverse(in.readValue(RemoteCommand.class.getClassLoader()));
        }
        ...
        if (type == SERVICE) {
            ...
            alias = in.readString();
            feature = RemoteStream.reverse(in.readValue(RemoteCommand.class.getClassLoader()));
            methodName = in.readString();
            constructor = (Object[]) RemoteStream.reverse(in.readValue(RemoteCommand.class.getClassLoader()));
            parameters = (Object[]) RemoteStream.reverse(in.readValue(RemoteCommand.class.getClassLoader()));
            //callbackClass = (Class<?>[]) RemoteStream.reverse(in.readValue(RemoteCommand.class.getClassLoader()));
        }
        if (type == SERVICE_CALLBACK) {
            callbackData = (Object[]) RemoteStream.reverse(in.readValue(RemoteCommand.class.getClassLoader()));
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return type == command.type &&
                ...
                equals(bridge, command.bridge);    // 属于同一个build和同一个method
    }
