...
//        if (sIsDebug == null) {
//            try {
//                ApplicationInfo info = DRouter.getContext().getApplicationInfo();
//                boolean isDebug = (info.flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
//                Log.d(RouterLogger.NAME, "app is debug: " + isDebug);
//                sIsDebug = isDebug;
//            } catch (Exception e) {
//                e.printStackTrace();
//                Log.w(RouterLogger.NAME, "app get debug state exception: " + Log.getStackTraceString(e));
//            }
//        }
//        return sIsDebug != null ? sIsDebug : true;
    }
